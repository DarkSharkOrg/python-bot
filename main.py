...
BOT_TOKEN = "7592496650:AAFP4xu4bUWEYsvfT9Km7gr0scpbsCU4A-0"
PAYMENT_CHANNEL = "@PAYOUT55557" #add payment channel here including the '@' sign
OWNER_ID = 7690211381 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@earningmafia_557"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
              #you can add as many channels here and also add the '@' sign before channel username
Daily_bonus = 1 #Put daily bonus amount here!
Mini_Withdraw = 15.00  #remove 0 and add the minimum withdraw u want to set
